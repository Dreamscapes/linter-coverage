...
class LinterCoverage {
  ...
  static strings = {
    messages: {
      ...
      uncoveredFunction: 'Function not covered by your test suite.',
    },
  }
    ...
    for (const record of this.coverage) {
      ...
      for (const func of record.functions.details) {
        ...
        messages.push({
          ...
          location: {
            file: record.file,
            position: [[func.line - 1, 0], [func.line - 1, 0]],
          },
          excerpt: LinterCoverage.strings.messages.uncoveredFunction,
        })
      }
    }
